	...
	<!--content-->
		<div class="product">
			...
			<div class="mid-popular">
					<?php 
						foreach($arr_detail_women_category_product as $product_women)
						{
					?>
					<div class="col-md-4 item-grid1 simpleCart_shelfItem">
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="<?php echo $product_women["c_img"]?>" class="img-responsive" alt="">
						<div class="zoom-icon ">
						<a class="picture" href="<?php echo $product_women["c_img"]?>" rel="title" class="b-link-stripe b-animate-go  thickbox"><i class="glyphicon glyphicon-search icon "></i></a>
						...
						<div class="women">
						<div class="women-top">
							<span><?php echo $product_women["c_sex"]?></span>
							<h6><a href="index.php?controller=detail_product&id=<?php echo $product_women["pk_product_id"]?>"><?php echo $product_women["c_name"]?></a></h6>
							</div>
							...
							<div class="mid-2">
								<p ><label></label><em class="item_price"><?php echo number_format($product_women["c_price"])?> VND</em></p>
								  <div class="block">
                    ...
                    <div class="mid-2">
                        <ul class="pagination" style="margin-left:12px;margin-top:0;margin-bottom:0;padding:0">
							...
							<?php
                                ...
                                {
                            ?>
                            <li class="<?php echo isset($_GET["p"])&&$_GET["p"]==$i?"active":"" ?>"><a href="index.php?controller=detail_women_category_product&p=<?php echo $i;?>"><?php echo $i;?></a></li>
                            <?php }?>
                        </ul>
                    </div>
                    <!--end phan trang-->
